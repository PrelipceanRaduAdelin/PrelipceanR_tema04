...
namespace ConsoleApp3
{
    ...
    class Objectoid
    {
        ...
        /// <summary>
        /// Constructorul in care sunt plasate initializarile
        /// </summary>
        public Objectoid(bool gravity_status)
        {
            ...
            int height_offset = rando.RandomInt(40, 60); // permite crearea de obiecte plasate la un mic offset de inaltime (diverse inaltime);
